...
class StreamingLLM:
    def __init__(
        ...
        **kwargs,
        ...
        engine_args = EngineArgs(model=model, quantization=quantization, dtype=dtype, enforce_eager=True, max_model_len=2048)
...
class Llama3(LLM):
    def __init__(self) -> None:
        self.llm = StreamingLLM(model="casperhansen/llama-3-8b-instruct-awq", quantization="AWQ", dtype="float16")
